...
public class BridgeUtil {
	...
	public final static String JS_HANDLE_MESSAGE_FROM_JAVA = "javascript:xm._handleMessageFromNative('%s');";
	public final static String JS_FETCH_QUEUE_FROM_JAVA = "javascript:xm._fetchQueue();";
	public final static String JAVASCRIPT_STR = "javascript:";
	//sharemarking
	public static String parseFunctionName(String jsUrl){
		return jsUrl.replace("javascript:xm.", "").replaceAll("\\(.*\\);", "");
	}
