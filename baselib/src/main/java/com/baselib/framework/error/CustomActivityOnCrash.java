...
package com.baselib.framework.error;
...
import com.baselib.framework.error.activity.DefaultErrorActivity;
...
public final class CustomActivityOnCrash {
     ...
     */
    public static void install(Context context, final boolean debug) {
        try {
            if (context == null) {
    ...
    public static int getDefaultErrorActivityDrawableIdFromIntent(Intent intent) {
        return intent.getIntExtra(CustomActivityOnCrash.EXTRA_IMAGE_DRAWABLE_ID, R.drawable.default_error_image);
    }
