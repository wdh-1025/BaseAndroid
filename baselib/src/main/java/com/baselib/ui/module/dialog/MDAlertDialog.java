...
public class MDAlertDialog implements View.OnClickListener {
    ...
    public MDAlertDialog(Builder builder) {
        ...
        mDialogView = View.inflate(mContext, R.layout.dialog_widget_md, null);
        ...
        mDialogView.setMinimumHeight(
                (int) (DisplayUtil.getScreenHeight(mContext) * builder.getHeight()));
