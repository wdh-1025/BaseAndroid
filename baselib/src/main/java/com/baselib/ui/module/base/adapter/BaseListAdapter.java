...
public abstract class BaseListAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    protected final BaseViewHolder onCreateBottomView(ViewGroup parent) {
        BottomViewHolder holder = new BottomViewHolder(mContext, mLayoutInflater.inflate(R.layout.base_list_footer, parent, false),
    ...
    protected abstract void onBindHeadViewData(BaseViewHolder helper);
}
