 ...
 */
public class BaseListEventHandler<T> implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private BaseListViewBuilder builder;
    //滑动的距离
    private int dx_, dy_;
    ...
    // 设置刷新状态为完成
    public void setRefreshSateFinished() {
        if (builder.mSwiperefreshlayout != null) {
