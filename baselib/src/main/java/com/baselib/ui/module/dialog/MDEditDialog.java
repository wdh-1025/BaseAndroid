...
public class MDEditDialog implements View.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public MDEditDialog(Builder builder) {
        ...
        mDialogView = View.inflate(mContext, R.layout.dialog_widget_edit, null);
        ...
        mDialogView.setMinimumHeight((int) (DisplayUtil.getScreenHeight(mContext) * builder.getMinHeight()));
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            mContext = context;
            titleText = "提示";
            titleTextColor = Color.parseColor("#363636");
            contentText = "";
            contentTextColor = Color.parseColor("#363636");
            leftButtonText = "取消";
            leftButtonTextColor = Color.parseColor("#363636");
            rightButtonText = "确定";
            rightButtonTextColor = Color.parseColor("#363636");
            lineColor = Color.parseColor("#363636");
            listener = null;
            isTitleVisible = true;
            isTouchOutside = true;
            hintText = "";
