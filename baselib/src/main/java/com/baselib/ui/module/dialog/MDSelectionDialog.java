...
public class MDSelectionDialog {
    ...
    public MDSelectionDialog(Builder builder) {
        ...
        dialogView = View.inflate(mContext, R.layout.dialog_widget_md_mid, null);
        ...
        lp.width = (int) (DisplayUtil.getScreenWidth(mContext) * builder.itemWidth);
    ...
    private void loadItem() {
        ...
        if (datas.size() == 1) {
            ...
            button.setBackgroundResource(R.drawable.dialog_selector_widget_md_single);
            ...
            for (int i = 0; i < datas.size(); i++) {
                ...
                if (i == 0) {
                    button.setBackgroundResource(R.drawable.dialog_selector_widget_md_top);
                } else if (i > 0 && i != datas.size() - 1) {
                    button.setBackgroundResource(R.drawable.dialog_selector_widget_md_middle);

                } else {
                    button.setBackgroundResource(R.drawable.dialog_selector_widget_md_bottom);
                }
                linearLayout.addView(button);
            }
        }
    ...
    private Button getButton(String text, int position) {
        ...
        button.setPadding(DisplayUtil.dip2px(mContext, 10), 0, DisplayUtil.dip2px(mContext, 10), 0);
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            mContext = context;
            onItemListener = null;
            itemHeight = DisplayUtil.dip2px(context, 45); // 默认item高度
            itemWidth = 0.75f;
            itemTextColor = Color.parseColor("#363636"); // 默认字体颜色
        ...
        public Builder setItemHeight(int dp) {
            this.itemHeight = DisplayUtil.dip2px(mContext, dp);
            return this;
        }
